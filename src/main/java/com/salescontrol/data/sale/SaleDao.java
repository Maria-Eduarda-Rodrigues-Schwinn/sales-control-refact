 ...
 * objetos de venda no banco de dados. Utiliza o EntityManager para gerenciar as transações.
 */
public class SaleDao {
   ...
   * @return uma lista de vendas que contêm produtos da categoria especificada.
   */
