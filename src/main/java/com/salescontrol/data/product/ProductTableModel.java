 ...
 *
 * <p>Esta classe estende AbstractTableModel e fornece a implementação necessária para exibir uma
 * lista de produtos em uma tabela. As colunas da tabela incluem ID, Nome, Categoria, Preço
 * Unitário, Unidade de Medida e Quantidade.
 */
public class ProductTableModel extends AbstractTableModel {
  ...
  private final String[] columnNames = {
    "ID", "Nome", "Categoria", "Preço Unitário", "Unidade de Medida", "Quantidade"
  };
  ...
  public Object getValueAt(int rowIndex, int columnIndex) {
    ...
    return switch (columnIndex) {
      ...
      case 2 -> product.getCategory().getTranslation();
      case 3 -> product.getUnitPrice();
      case 4 -> product.getUnitOfMeasure().getTranslation();
