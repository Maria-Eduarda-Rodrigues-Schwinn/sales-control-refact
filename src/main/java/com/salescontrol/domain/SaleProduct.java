 ...
 *
 * <p>Esta classe é uma entidade JPA que mapeia para a tabela "venda_produto" no banco de dados.
 * Representa a associação entre uma venda e um produto, incluindo a quantidade e os preços.
 */
@Entity
@Table(name = "venda_produto")
public class SaleProduct implements Serializable {

  @EmbeddedId private SaleProductId id = new SaleProductId();
  ...
  /**
   * Construtor para inicializar a classe SaleProduct com um produto, quantidade e preço unitário.
   *
