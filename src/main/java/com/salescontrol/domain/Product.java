 ...
 *
 * <p>Esta classe é uma entidade JPA que mapeia para a tabela "produto" no banco de dados.
 * Representa as informações de um produto, incluindo ID, nome, categoria, preço unitário, unidade
