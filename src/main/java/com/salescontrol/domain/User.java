 ...
 *
 * <p>Esta classe é uma entidade JPA que mapeia para a tabela "usuario" no banco de dados.
 * Representa as informações de um usuário, incluindo ID, nome, login, senha e tipo de usuário.
 */
@Entity
@Table(name = "usuario")
