 ...
 *
 * <p>Esta classe é uma entidade JPA que mapeia para a tabela "venda" no banco de dados. Representa
 * as informações de uma venda, incluindo ID, data da venda, valor total e produtos vendidos.
 */
@Entity
@Table(name = "venda")
