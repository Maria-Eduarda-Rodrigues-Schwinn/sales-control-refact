 ...
 *
 * <p>Esta classe estende JFrame e fornece a interface gráfica para o registro de produtos. Permite
 * adicionar novos produtos, limpar campos e navegar para outras telas como registro de venda,
 * edição de produto e relatório de vendas.
 */
public class RegisterProduct extends javax.swing.JFrame {
  ...
  /**
   * Construtor para inicializar a tela de registrar produtos com o usuário atual.
   *
   ...
   *
   * <p>Limpa todos os campos de entrada na tela de registro de produto.
   *
   * @param evt o evento de ação.
   */
  private void btnClearFieldsActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_btnClearFieldsActionPerformed
    txtName.setText("");
    txtQuantity.setText("");
   ...
   *
   * <p>Adiciona um novo produto com base nos dados fornecidos e exibe uma mensagem de confirmação.
   * Exibe mensagens de erro se os campos de entrada estiverem vazios ou contiverem valores
   * inválidos.
   *
   * @param evt o evento de ação.
   */
  private void btnAddProductActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_btnAddProductActionPerformed
   ...
   *
   * <p>Este método retorna uma lista de descrições de todas as categorias de produto.
   *
   ...
   *
   * <p>Este método retorna uma lista de descrições de todas as unidades de medida.
   *
   ...
   *
   * <p>Este método retorna a unidade de medida correspondente à descrição fornecida.
   *
   * @param description a descrição da unidade de medida.
   * @return a unidade de medida correspondente à descrição ou null se não encontrado.
   */
