 ...
 *
 * <p>Esta classe implementa o padrão Singleton para garantir que apenas uma instância de
 * DataManager exista. Gerencia produtos, vendas e um carrinho temporário.
 */
public class DataManager {
  ...
  /** Carrinho temporário para armazenar produtos antes da finalização da venda. */
  private Map<Integer, Integer> temporaryCart;

  /**
   * Construtor privado para inicializar o DataManager.
   *
   * <p>Inicializa as listas de produtos, vendas e o carrinho temporário.
   */
  private DataManager() {
   ...
   *
   * <p>Se o produto já estiver no carrinho, a quantidade é atualizada.
   *
   ...
   *
   * <p>Remove todos os produtos do carrinho temporário.
   */
